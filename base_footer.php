<footer class="ftco-footer ftco-bg-dark ftco-section">
    <div class="container">
      <div class="row mb-5">
        <div class="col-md-6 col-lg-3">
          <div class="ftco-footer-widget mb-5">
            ...
            <div class="block-23 mb-3">
              <ul>
                <li>
                  <span class="icon icon-map-marker"></span><span class="text">Near old warehouse, Angara gadia,
                    Balasore</span>
                </li>
                <li>
                  <a href="#"><span class="icon icon-phone"></span><span class="text">+919938642448,
                      +919337340050</span></a>
                </li>
                <li>
                  <a href="#"><span class="icon icon-envelope"></span><span
                      class="text">stmotherteresapublicschool2012@gmail.com</span></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="ftco-footer-widget mb-5">
            <h2 class="ftco-heading-2">Gallery and Blog</h2>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <p>
            ...
            All rights reserved | Design And Develop By
            <i class="icon-heart" aria-hidden="true"></i> by
            <a href="#" target="_blank">KritiAdo</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </p>
        </div>
      </div>
